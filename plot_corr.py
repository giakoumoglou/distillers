...
def parse_option():
    ...
    #opt.path_s = './save/student_model/S_wrn_40_1_T_wrn_40_2_cifar100_ard_r_1_a_1.0_b_1.0_1/wrn_40_1_last.pth'
...
def main():
    ...
    for data, targets in val_loader:
        with torch.no_grad():
            ...
            plot_difference(corr_t.detach().cpu().numpy(), corr_s.detach().cpu().numpy())
            break
...
def plot_difference(corr_t, corr_s):
    ...
    plt.grid(False) 
    plt.savefig('corr_difference.png', dpi=300, format='png', bbox_inches='tight')
    plt.show()  
    plt.close()
