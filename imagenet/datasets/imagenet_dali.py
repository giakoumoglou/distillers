...
def create_dali_pipeline(data_dir, crop, size, shard_id, num_shards, dali_cpu=False, is_training=True):
    """Define the DALI pipeline for data loading and augmentation"""
...
def get_dali_data_loader(args):
    """Create DALI data loaders for training and validation datasets"""
    crop_size = 224
    val_size = 256

    path = r'\\rds.imperial.ac.uk\RDS\user\ng1523\home\datasets'
