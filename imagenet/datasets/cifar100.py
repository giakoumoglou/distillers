...
class CIFAR100BackCompat(datasets.CIFAR100):
    """CIFAR-100 dataset with backward compatibility for accessing labels and data"""
    @property
...
class CIFAR100Instance(CIFAR100BackCompat):
    """CIFAR-100 dataset instance with index return for sampling"""
...
def get_cifar100_dataloaders(batch_size=128, num_workers=8, is_instance=False):
    """Create CIFAR-100 dataloaders for training and testing"""
...
class CIFAR100InstanceSample(CIFAR100BackCompat):
    """CIFAR-100 dataset instance with positive and negative sampling for contrastive learning"""
...
def get_cifar100_dataloaders_sample(batch_size=128, num_workers=8, k=4096, mode='exact', is_sample=True, percent=1.0):
    """Create CIFAR-100 dataloaders with positive and negative sampling for contrastive learning"""
    data_folder = get_data_folder()
