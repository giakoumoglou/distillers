...
from datasets import get_imagenet_dataloader, get_dali_data_loader

from utilities import save_dict_to_json, reduce_tensor, adjust_learning_rate
from utilities import train_vanilla as train, validate_vanilla


def parse_option():

    parser = argparse.ArgumentParser('Arguments for training teacher network')
    ...
    parser.add_argument('--lr_decay_riate', type=float, default=0.1, help='decay rate for learning rate')
